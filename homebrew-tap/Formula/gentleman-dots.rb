class GentlemanDots < Formula
  ...
  homepage "https://github.com/mabuabaranlc/Gentleman.Dots"
  version "2.7.7"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/mabuabaranlc/Gentleman.Dots/releases/download/v#{version}/gentleman-installer-darwin-arm64"
      sha256 "d36aba07893727f7dc516e2ea8063d2ac86807a8a97efc753492960070d52204"
    end
    on_intel do
      url "https://github.com/mabuabaranlc/Gentleman.Dots/releases/download/v#{version}/gentleman-installer-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/mabuabaranlc/Gentleman.Dots/releases/download/v#{version}/gentleman-installer-linux-arm64"
      sha256 "f96ac64498c4c4d9de54c5cb2df005367210c4632b5078b07ab2b3632336087a"
    end
    on_intel do
      url "https://github.com/mabuabaranlc/Gentleman.Dots/releases/download/v#{version}/gentleman-installer-linux-amd64"
